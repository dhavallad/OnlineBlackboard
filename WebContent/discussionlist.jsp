					...
					<div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
						<div class="inner">
							<ul class="breadcrumb">
								...
								<li><a class="active">Discussion Board</a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="container-fluid container-fixed-lg">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3>
								Discussion Board<%=session.getAttribute("session_courseid")%></h3>
						...
						<div class="panel-body">
								...
								<ul class="pager wizard">
									<li class="">
										<button class="btn btn-primary pull-right" type="button"
											onclick="window.location='PostDiscussion'">
							...
							<div class="row">
								<div class="table-responsive col-md-12	">
									<c:if test="${not empty discussionlistmessage}">
										<div class="pgn pgn-bar">
											<div class="alert alert-danger">
												<span><c:out value="${discussionlistmessage}"></c:out></span>
											</div>
										</div>
									</c:if>
									<%session.setAttribute("discussionlistmessage",null);%>
									<table class="table">
										<thead>
											<tr>
										...
										<tbody id="pastcomments">
											<c:if test="${empty questionList}">
												<tr>
													<td class="col-md-10">No discussion found.</td>
												</tr>
											</c:if>
											<!-- <tr>
											...
											<c:forEach var="question" items="${questionList}">
												<tr>
													<td class="col-md-10"><a
														href="QuestionDiscussion?questionid=${question.quesitonid}">
															<p class="text-black">
													...
													<td>
														<div class="btn-group sm-m-t-3">
															...
															<button type="button" class="btn btn-default"
																onclick="window.location='UpdateDiscussion?action=delete&discussionid=${question.quesitonid}'">
