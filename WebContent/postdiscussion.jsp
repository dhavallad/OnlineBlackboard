							...
							<ul class="breadcrumb">
								...
								<li><a
									href="DiscussionBoard?courseid=<%=session.getAttribute("session_courseid")%>">Discussion
										Board</a></li>
								<li><a class="active">Create Discussion</a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="container-fluid container-fixed-lg">
					<div class="panel panel-default">
						<div class="panel-body">
							<div class="col-sm-10">
								<h3>Create Discussion Topic.</h3>
								<p>Want it to be more Descriptive and User Friendly, We Made
									it possible, Use Seperaed Form Layouts Structure to Presentate
									your Form Fields.</p>
								<br>
								<form id="form-disc" class="form-horizontal" role="form"
									method="post"
									action="PostDiscussion">
									<div class="form-group">
										<label for="name" class="col-sm-3 control-label">Discussion
											Topic</label>
										<div class="col-sm-9">
											<textarea rows="10" class="form-control" id="dis_question"
												name="dis_question"
												placeholder="Please Describe Discussion Question" required></textarea>
										</div>
									</div>
									<br>
									<div class="row">
