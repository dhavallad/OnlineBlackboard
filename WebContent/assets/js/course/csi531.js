...
function saveComment() {
	restoreArrayData();
	if(localStorage.getItem("csi531comments")!=null){
		var commentArray = JSON.parse(localStorage.getItem("csi531comments"));		
	}else{
		var commentArray = [];
	}
    ...
    localStorage.setItem("csi531comments", JSON.stringify(commentArray));
    location.reload();
}

function restoreArrayData() {
	 console.log("Restoring array data from local storage.");
	 console.log(localStorage.getItem("csi531comments"));
	    if(localStorage.getItem("csi531comments")!=null){
	    	var commentArray = JSON.parse(localStorage.getItem("csi531comments"));
