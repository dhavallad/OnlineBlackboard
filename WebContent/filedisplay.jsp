					...
					<div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
						<div class="inner">
							<ul class="breadcrumb">
								...
								<li><a href="csi500.jsp" class="active">Operating
										Systems</a></li>
							</ul>
						</div>
					</div>
...
<a class="remove" href="javascript:;"></a>
 ...
 -->
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-12">
									<p class="m-b-20">Introduction to operating systems. Topics
										include processes, concurrency, synchronization, deadlock,
										memory management, segmentation, paging, replacement policies,
							...
							<div class="row">
								<div class="col-md-12">
									<!-- <iframe src="uploads/DhavalLad.pdf" width="100%" height="640"></iframe> -->
									<iframe src="/Users/dhavallad/Documents/workspace/Lab/WebContent/uploads/DhavalLad.pdf" width="100%" height="640"></iframe>
								</div>
							</div>
							<div class="row m-l-100">
								<div class="col-md-11">
									<h3 class="m-t-30 m-b-20">Comments</h3>
									...
									<!-- <button class="text-center btn btn-success btn-cons m-t-10 pull-right" onclick="Javascript:restoreArrayData()">Show</button>
<button class="text-center btn btn-success btn-cons m-t-10 pull-right" onclick="Javascript:clearStorage()">Clear</button>
<button class="text-center btn btn-success btn-cons m-t-10 pull-right" onclick="Javascript:DisplayData()">Display</button>
 -->
								</div>
							</div>
