...
<a class="remove" href="javascript:;"></a>
 ...
 -->
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-12">
									<p class="m-b-20">A course on data mining (finding patterns
										in data) algorithms and their application to interesting data
										types and situations. We cover algorithms that address the
										...
										data. Prerequisite(s): I CSI/I CEN 213.</p>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12">
									<iframe src="assets/pdf/syl531.pdf" width="100%" height="640"></iframe>
								</div>
							</div>
