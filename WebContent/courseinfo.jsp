						...
						<div class="panel-body">
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="panel panel-default">
										<div class="panel-heading separator">
											<div class="panel-title">Grade Center</div>
										</div>
										<div class="panel-body p-t-5">
											<p>This section contains the grade for all student who enroll
												in this course.</p>
											<a href="GradeCenter?courseid=${courseInfo.courseid}"><b>Go
													to Grade Center</b></a>
										</div>
									</div>
								</div>
