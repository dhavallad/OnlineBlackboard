	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (ServletFileUpload.isMultipartContent(request)) {
			...
			try {
				...
				if (isUploaded) {
//					request.setAttribute("contentpagemessage", "File:" + filename + " uploaded successfully.");
					System.out.println("File:" + filename + " uploaded successfully.");
					request.getSession().setAttribute("contentpagemessage","Content : "+contentname + " uploaded successfully.");
					response.sendRedirect("CourseContent?courseid="+courseid);
//					request.getRequestDispatcher("CourseContent?courseid="+courseid).forward(request, response);
				}
